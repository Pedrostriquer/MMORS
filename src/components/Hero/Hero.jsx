...
import { Link } from 'react-router-dom'; // Importado para o botão funcionar
import './Hero.css';

// Imagens conforme seu código original
  ...
  return (
    <section className="hero-container">
      <div className="hero-content">
        ...
        {/* LADO ESQUERDO COM ANIMAÇÃO (Mantido original) */}
        <div className="hero-left animate-hero-left">
          ...
          <div className="left-assets-wrapper">
            ...
            {/* CTA ESTILO INPUT - AGORA FUNCIONAL */}
        ...
        {/* LADO DIREITO - MANTIDO SEU TRANSLATE */}
